...
# from Flask-Bulma.blueprints.admin import admin
# from Flask-Bulma.blueprints.page import page
# from Flask-Bulma.blueprints.contact import contact
# from Flask-Bulma.blueprints.user import user
# from Flask-Bulma.blueprints.billing import billing
# from Flask-Bulma.blueprints.billing import stripe_webhook
# from Flask-Bulma.blueprints.bet import bet
# from Flask-Bulma.blueprints.user.models import User
# from Flask-Bulma.blueprints.billing.template_processors import (
#   format_currency,
#   current_year
# )
# from Flask-Bulma.extensions import (
    # debug_toolbar,
    # mail,
    # csrf,
    # db,
...
# CELERY_TASK_LIST = [
#     'Flask-Bulma.blueprints.contact.tasks',
#     'Flask-Bulma.blueprints.user.tasks',
#     'Flask-Bulma.blueprints.billing.tasks',
# ]
